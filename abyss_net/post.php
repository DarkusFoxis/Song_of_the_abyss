...
<head>
    ...
    <meta property="og:url" content="https://so-ta.ru/abyss_net/post?id=<?php echo $row['id_post']; ?>"/>
                ...
                <div class="post-card">
                    ...
                    <div class="rating-container">
                        ...
                        <div class="rating-value">
                            <span id="rating-<?php echo $row['id_post']; ?>"><?php echo round($row['total_rating'], 2); ?></span>
                        </div>
                    </div>

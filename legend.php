...
//if($user['NSFW']) {
//echo '<a href="./hentai" class="link"><div class="card">';
//echo '<img src="./img/icon_lit.png" alt="Иконка сокрытного" title="Не прячь свои желания~" width="235" height="235" style="object-fit: cover;">';
//echo '<p style="text-align:center;">Сокрытное</p>';
//echo '</div></a>';
//}
//}
//}

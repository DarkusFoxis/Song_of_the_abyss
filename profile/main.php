...
<div class="navbar">
    ...
    <?php if (isset($_SESSION['user'])): ?>
        <a href="./setting" class="link" style="float: right;">Настройки</a>
        <a href="./search_profile" class="link" style="float: right;">Аккаунты</a>
                            ...
                            if ($result && $result->num_rows > 0) {
                                        ...
                                        <?php if ($invent): ?>
                                            <div class="profile-stats-grid">
                                                ...
                                                <div class="profile-stat-item">
                                                    ...
                                                    <div class="profile-stat-value"><?php echo number_format($sakura, 0, " ", " "); ?></div>
                                                </div>
                                                <div class="profile-stat-item">
                                                    <div class="profile-stat-label">Кейсы</div>
                                                    <div class="profile-stat-value"><span class="case_count"><?php echo number_format($cases, 0, " ", " "); ?></span></div>
                                                </div>
                                                <div class="profile-stat-item">
                                                    <div class="profile-stat-label">Поддержка проекта</div>
                                                    <div class="profile-stat-value donate-value"><?php echo number_format($donate_amount, 2, ",", " "); ?> руб.</div>
                                                </div>
                                                <div class="profile-stat-item">
                                                    <div class="profile-stat-label">Эфир бездны</div>
                                                    <div class="profile-stat-value donate-value"><?php echo number_format($ether, 7, ',', ' '); ?> ед.</div>
                                                </div>
                                            </div>
                                            ...
                                            <?php if ($xp >= $xp_max):
                                                $next_lvl = $lvl + 1;
                                                $cost_coins = 350 * $next_lvl * (($next_lvl + 9)/10);
                                                $cost_up = 0;
                                                if (($next_lvl % 10) == 0) {
                                                    $cost_up = 10000 * floor($next_lvl / 10);
                                                }
                                            ?>
                                                <p style="margin: 15px 0 5px 0; font-size: 0.95rem;">
                                                    Достаточно опыта для повышения уровня! Необходимо:
                                                    <b><?php echo number_format($cost_coins, 0, '', ' '); ?> монет<?php if($cost_up > 0): ?> и <?php echo number_format($cost_up, 0, '', ' '); ?> лепестков<?php endif; ?></b>.
                                                </p>
                                            <?php endif; ?>
                                ...
                                <div class="profile-actions">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="./ether_shop">Рынок эфира</a></li>
                                        <li><a href="./stiker">Стикеры</a></li>
                                        <li><a href="../abyss_net/main">Abyss net-Блог</a></li>
                                        <li><a href="https://t.me/song_of_the_abyss">Обратная связь</a></li>
                                        <li><a href="./ai/art_chat">Генерация картинок (BETA)</a></li>
                                        <li><a href="./ai/rp_chat">РП с нейросетью (BETA)</a></li>

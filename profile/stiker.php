...
<head>
	...
	<style>
		...
		.rarity-item:hover {background: rgba(255,255,255,0.1);}
		.rarity-item.active {background: rgba(75, 0, 130, 0.5); box-shadow: 0 0 10px rgba(147, 112, 219, 0.6);}
		.rarity-indicator {
			width: 20px;
			height: 20px;
			border-radius: 50%;
		...
		.card:hover {transform: translateY(-5px); box-shadow: 0 5px 15px rgba(75, 0, 130, 0.4);}
		...
		.sticker-count {font-size: 0.9em; margin: 5px 0;}
		.sticker-exclusive {
		...
		button:hover {background-color: #5A1A9A;}
        .buy_button {
            display: flex;
            justify-content: center;
            align-items: center;
		...
		@media (max-width: 992px) {
			.rarity-sidebar {flex: 0 0 100%; order: 1;}
			.content-area {flex: 0 0 100%; order: 2;}
		}
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<ul>
				    <li>com - Обычный (10 уникальных).</li>
				    <li>rar - Редкий (9 уникальных).</li>
				    <li>epic - Эпический (9 уникальных).</li>
				    <li>leg - Легендарный (6 уникальных).</li>
				    <li>myst - Мистический (6 уникальных).</li>
				    <li>Всего - 40 уникальных стикеров!</li>
				</ul>
				...
				<p class="buy_button"><button onclick='stikerByu("com")'>Обычный (100 лепестков)</button> <button onclick='stikerByu("rar")'>Редкий (225 лепестков)</button> <button onclick='stikerByu("epic")'>Эпический (500 лепестков)</button> <button onclick='stikerByu("leg")'>Легендарный (1010 лепестков)</button> <button onclick='stikerByu("myst")'>Мистический (2500 лепестков)</button> <button onclick='stikerByu("rnd")'>Рандом (200 лепестков)</button></p>
				<p id="result"></p>
